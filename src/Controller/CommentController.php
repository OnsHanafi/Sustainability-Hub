...
class CommentController extends AbstractController
{
    ...
    public function edit($id,Request $request, Comment $comment, CommentRepository $commentRepository, MailerInterface $mailer): Response
    {
    ...
    public function new($id,Request $request,PostRepository $rep, CommentRepository $commentRepository, MailerInterface $mailer): Response
    {
