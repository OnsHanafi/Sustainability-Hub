...
class ReclamationController extends AbstractController
{
   ...
   public function index()
    ...
    public function read(Request $request,ReclamationRepository $ReclamationRepository,SerializerInterface $serializerInterface, PaginatorInterface $paginator ):Response
    {
        $reclamation=$ReclamationRepository->findAll();
